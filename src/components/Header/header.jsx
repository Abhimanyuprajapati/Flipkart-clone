  ...
  return (
    <div className="header">
      <div className="header_first">
        <img
          src="https://raw.githubusercontent.com/Abhimanyuprajapati/Flipkart-clone/main/src/img/flipkart-plus_8d85f4%20(1).png"
          onClick={homepage}
          alt="flipkart logo"
        />
        <div className="header_logo" onClick={pluspage}>
          ...
          <span
            style={{ color: "#ffe500", fontWeight: "500", marginRight: "3" }}
          >
            Plus
          </span>
          <span>
            <img
              src="https://raw.githubusercontent.com/Abhimanyuprajapati/Flipkart-clone/main/src/img/plus_aef861.png"
              alt="logo"
            />
          </span>
        </div>
      ...
      <div className="header_third">
        {userDataArr.length == 0 ? (
          ...
          <Tippy theme="light" interactive={true} content={<UserDetail />}>
            <span className="getnamestyle">{userDataArr[0].username}</span>
          </Tippy>
        )}
      </div>
      ...
      <div className="header_sixth" onClick={cardRoute}>
        ...
        <span>
          {cartCount == 0 ? (
            ...
            <sup style={{ marginLeft: "5px", fontSize: "18px" }}>
              {cartCount.length}
            </sup>
          )}
        </span>
 ...
 *  // let firstcapital;
    ...
    // this is from the Google auth  firebase
    // const GoogleUser = JSON.parse(localStorage.getItem('GoogleUser')) || [];
    // console.log("this is me from local storage of Google Auth",GoogleUser);
    ...
    //   console.log("this is eval",el)
      ...
      // firstcapital=first.toUpperCase()
    // })
    // console.log("this is me name store",firstcapital1);
 */
